...
c_writer.writerow(['MS_ROI_1A',str(seg_para)])
...
#for pose_id in [6,7]:
    ...
    roi=skgti.core.fill_region(sp.misc.imread(os.path.join(truth_dir,"region_1A.png")))
    ...
    try :
        ...
        id2r, matcher = skgti.core.recognize_regions(image, label, t_desc, p_desc, roi=roi, verbose=True,
                                                     filter_size=20, background=False, mc=True)  # 7 labels
