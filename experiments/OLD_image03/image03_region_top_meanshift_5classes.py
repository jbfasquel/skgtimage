...
save_dir="../../Database/image03/top_meanshift_5classes_bf/"
...
id2r,matcher=skgti.core.recognize_regions(image,label,t_desc,p_desc,roi=roi,filtering=4,verbose=True,bf=True)
