...
save_dir="Database/image04/test1/"
...
#########
#COLOR IMAGE
image_rgb=sp.misc.imread(os.path.join(input_dir,"image04_filtered_test1.png"))
image=sp.misc.imread(os.path.join(input_dir,"image04_filtered_test1_gray.png"))
roi=np.ones(image.shape)
#########
