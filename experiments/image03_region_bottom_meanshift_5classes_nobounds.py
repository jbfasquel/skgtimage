...
save_dir="../../Database/image03/bottom_meanshift_5classes_nobounds/"
...
# RECOGNITION
id2r,matcher=skgti.core.recognize_regions(image,label,t_desc,p_desc,roi=roi,manage_bounds=False,thickness=2,filtering=1,verbose=True)
