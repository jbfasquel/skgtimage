...
save_dir="Database/image03/meanshift_down3_region_top_test1_newfiltering2/"
...
#for i in range(0,3): image_rgb[:,:,i]=sp.ndimage.filters.median_filter(image_rgb[:,:,i], 3)
...
###########################################
'''
matching,(common_isomorphisms,(t_isomorphisms,p_isomorphisms))=skgti.core.find_common_subgraph_isomorphisms([built_t_graph,built_p_graph],[t_graph,p_graph],True)
