...
save_dir="Database/image00/test1/"
...
# PLOT MATCHING
skgti.io.plot_graph_matchings(built_t_graph,t_graph,t_isomorphisms) #;plt.show()
plt.savefig(save_dir+'03_t_iso.png');plt.gcf().clear()
skgti.io.plot_graph_matchings(built_p_graph,p_graph,p_isomorphisms) #;plt.show()
plt.savefig(save_dir+'03_p_iso.png');plt.gcf().clear()
skgti.io.plot_graph_surjection(built_t_graph,t_graph,matching) #;plt.show()
...
skgti.io.plot_graphs_regions_new([t_graph,p_graph])
plt.savefig(save_dir+'04_result.png');plt.gcf().clear()
plt.show()
'''
model=skgti.core.TPModel(t_graph,[p_graph])
skgti.io.plot_model(model);plt.title("Final");plt.show()
'''