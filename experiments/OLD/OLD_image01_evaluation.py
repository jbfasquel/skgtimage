...
graph_based_regions.add(2,tp_model.get_region("file"))
graph_based_regions.add(3,tp_model.get_region("paper"))
graph_based_regions.add(4,tp_model.get_region("text"))
